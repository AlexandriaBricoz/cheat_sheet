...
print(counter.most_common(
    3))  # выводит 3 самые частые буквы или что то другое семое частое, если задать больше чем есть, то выведет всё
...
print(a_deque)
b_deque = deque([1, 2, 3],
                maxlen=3)  # задаётся максимальная длинна, если добавить элемент, с противоположного конца элемент удалиться
print(b_deque)
